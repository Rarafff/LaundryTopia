...
public class TinyDB {
    ...
    public ArrayList<ServicesDomain> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<ServicesDomain> playerList =  new ArrayList<ServicesDomain>();

        for(String jObjString : objStrings){
            ServicesDomain player  = gson.fromJson(jObjString,  ServicesDomain.class);
    ...
    public void putListObject(String key, ArrayList<ServicesDomain> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(ServicesDomain player: playerList){
